...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Plateforme de gestion des étudiants pour l'École de Gestion et de Commerce — Martinique." },
      { name: "author", content: "EGC Martinique" },
      ...
      { name: "twitter:site", content: "@EGCMartinique" },
    ],
    links: [
      {
        rel: "stylesheet",
