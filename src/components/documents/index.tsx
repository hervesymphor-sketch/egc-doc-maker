...
export function CarteEtudiant({ student, settings }: Props) {
  return (
    <div className="doc-a4 flex flex-col items-center justify-start gap-6 pt-12">
      ...
      {/* Recto */}
      <div className="rounded-xl overflow-hidden shadow-xl" style={{ width: "85.6mm", height: "53.98mm", background: "linear-gradient(135deg, #6B21A8 0%, #4C1D95 100%)", color: "white", padding: "4mm", display: "flex", gap: "4mm" }}>
        {student.photo ? (
          <img src={student.photo} alt="" className="rounded-md object-cover" style={{ width: "30mm", height: "45mm" }} crossOrigin="anonymous" />
        ) : (
          <div className="rounded-md bg-white/20 flex items-center justify-center text-3xl font-bold" style={{ width: "30mm", height: "45mm" }}>
        ...
        <div className="flex-1 flex flex-col justify-between">
          ...
          <div className="text-[6px] opacity-50">Année {new Date().getFullYear()}-{new Date().getFullYear() + 1}</div>
        </div>
      </div>
